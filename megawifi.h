...
#define MW_CMD_DEF_AP_GET	  8		///< Get default AP configuration
#define MW_CMD_DEF_AP_SET	  9		///< Set default AP configuration
#define MW_CMD_AP_JOIN		 10		///< Join access point
#define MW_CMD_AP_LEAVE		 11		///< Leave previously joined access point
