...
#define MW_CMD_IP_CFG		  5
#define MW_CMD_AP_JOIN		  6
#define MW_CMD_AP_LEAVE		  7
#define MW_CMD_TCP_CON		  8
#define MW_CMD_TCP_BIND		  9
#define MW_CMD_TCP_ACCEPT	 10
#define MW_CMD_TCP_STAT		 11
#define MW_CMD_TCP_DISC		 12
#define MW_CMD_UDP_SET		 13
#define MW_CMD_UDP_STAT		 14
